...
// 创建canvas实例
const canvas = createCanvas(760, 760); //画布的大小 
const ctx = canvas.getContext('2d');

// 读取背景图片文件夹
const bgImgDir = '/Users/ryanweng/Documents/Cuppowood/website/产品导入/Shopify/Cabinet/';
  ...
  loadImage(bgImgPath).then(bgImg => {
    ...
    for (let j = 0; j < fgImgs.length; j++) {
      ...
      loadImage(fgImgPath).then(fgImg => {
        ...
        const outputDir = '/Users/ryanweng/Documents/Cuppowood/website/产品导入/Shopify/ConcatPhoto/';
